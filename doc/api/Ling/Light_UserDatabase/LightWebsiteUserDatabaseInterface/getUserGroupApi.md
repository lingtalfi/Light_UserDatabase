...
LightWebsiteUserDatabaseInterface::getUserGroupApi
================



LightWebsiteUserDatabaseInterface::getUserGroupApi — Returns a UserGroupApiInterface instance.
...
Source Code
===========
See the source code for method [LightWebsiteUserDatabaseInterface::getUserGroupApi](https://github.com/lingtalfi/Light_UserDatabase/blob/master/LightWebsiteUserDatabaseInterface.php#L125-L125)
...
Previous method: [getUserHasPermissionGroupApi](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/LightWebsiteUserDatabaseInterface/getUserHasPermissionGroupApi.md)<br>Next method: [getPluginOptionApi](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/LightWebsiteUserDatabaseInterface/getPluginOptionApi.md)<br>
