...
LightWebsiteUserDatabaseInterface::getPluginOptionApi
================



LightWebsiteUserDatabaseInterface::getPluginOptionApi — Returns a PluginOptionApiInterface instance.
...
Source Code
===========
See the source code for method [LightWebsiteUserDatabaseInterface::getPluginOptionApi](https://github.com/lingtalfi/Light_UserDatabase/blob/master/LightWebsiteUserDatabaseInterface.php#L131-L131)
...
Previous method: [getUserGroupApi](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/LightWebsiteUserDatabaseInterface/getUserGroupApi.md)<br>Next method: [getUserGroupHasPluginOptionApi](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/LightWebsiteUserDatabaseInterface/getUserGroupHasPluginOptionApi.md)<br>
