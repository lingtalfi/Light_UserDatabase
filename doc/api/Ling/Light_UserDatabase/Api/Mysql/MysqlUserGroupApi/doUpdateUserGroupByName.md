...
Source Code
===========
See the source code for method [MysqlUserGroupApi::doUpdateUserGroupByName](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Mysql/MysqlUserGroupApi.php#L263-L269)
