...
PermissionGroupHasPermissionApiInterface::getPermissionGroupHasPermission — Returns the permissionGroupHasPermission row identified by the given where conditions.
