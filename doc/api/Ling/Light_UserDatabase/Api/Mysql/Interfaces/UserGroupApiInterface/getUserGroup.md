...
UserGroupApiInterface::getUserGroup — Returns the userGroup row identified by the given where conditions.
...
Returns the userGroup row identified by the given where conditions.
