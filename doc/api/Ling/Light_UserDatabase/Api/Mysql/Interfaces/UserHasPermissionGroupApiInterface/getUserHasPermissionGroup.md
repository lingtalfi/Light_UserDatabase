...
UserHasPermissionGroupApiInterface::getUserHasPermissionGroup — Returns the userHasPermissionGroup row identified by the given where conditions.
...
Returns the userHasPermissionGroup row identified by the given where conditions.
