...
Source Code
===========
See the source code for method [UserApi::deleteUserById](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Mysql/Classes/UserApi.php#L174-L180)
